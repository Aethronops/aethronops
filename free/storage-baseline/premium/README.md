...
![Resources](https://img.shields.io/badge/Terraform%20Resources-34-844FBA)
...
| | |
|---|---|
| **Pattern** | `storage-baseline` |
| **Tier** | premium (Enterprise) |
| **AVM Modules** | 10 Azure Verified Modules |
| **Terraform Resources** | 34 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (10 modules, 34 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 10 modules AVM, 34 Terraform resources, premium tier</sub>
</p>
...
**SLA composite** : **99.7303%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.99% × 99.99% × 99.99% × 99.99% × 99.99% × 99.90% = 99.7303%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 116.53 minutes |
| Par an | 1418.72 minutes (23.65 heures) |
