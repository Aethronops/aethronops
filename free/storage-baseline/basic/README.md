...
![Resources](https://img.shields.io/badge/Terraform%20Resources-13-844FBA)
...
| **Terraform Resources** | 13 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (5 modules, 13 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 5 modules AVM, 13 Terraform resources, basic tier</sub>
</p>
...
**SLA composite** : **99.7801%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.90% = 99.7801%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 94.98 minutes |
| Par an | 1156.37 minutes (19.27 heures) |
