# governance-organization — Production

<!-- Badges -->
![Terraform](https://img.shields.io/badge/Terraform-%3E%3D1.9-844FBA?logo=terraform&logoColor=white)
![AVM](https://img.shields.io/badge/Azure%20Verified%20Modules-5%20modules-0078D4?logo=microsoftazure&logoColor=white)
![Resources](https://img.shields.io/badge/Terraform%20Resources-9-844FBA)
...
| **AVM Modules** | 5 Azure Verified Modules |
| **Terraform Resources** | 9 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (5 modules, 9 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 5 modules AVM, 9 Terraform resources, standard tier</sub>
</p>
...
**Formule** : 99.90% × 99.90% × 99.90% × 99.90% = 99.6006%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 172.54 minutes |
| Par an | 2100.69 minutes (35.01 heures) |
