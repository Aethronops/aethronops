# governance-organization — POC / Dev

<!-- Badges -->
![Terraform](https://img.shields.io/badge/Terraform-%3E%3D1.9-844FBA?logo=terraform&logoColor=white)
![AVM](https://img.shields.io/badge/Azure%20Verified%20Modules-3%20modules-0078D4?logo=microsoftazure&logoColor=white)
![Resources](https://img.shields.io/badge/Terraform%20Resources-5-844FBA)
...
| **Tier** | basic (POC / Dev) |
| **AVM Modules** | 3 Azure Verified Modules |
| **Terraform Resources** | 5 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (3 modules, 5 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 3 modules AVM, 5 Terraform resources, basic tier</sub>
</p>
...
**SLA composite** : **99.8001%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.90% = 99.8001%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 86.36 minutes |
| Par an | 1051.39 minutes (17.52 heures) |
