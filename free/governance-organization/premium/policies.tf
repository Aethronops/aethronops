...
resource "azurerm_management_group_policy_assignment" "iso27001" {
  name                 = "ao-iso27001"
  display_name         = "AethronOps — ISO 27001:2013"
  management_group_id  = azurerm_management_group.management_group.id
...
resource "azurerm_management_group_policy_assignment" "nist_800_53" {
  name                 = "ao-nist_800_53"
  display_name         = "AethronOps — NIST SP 800-53 Rev. 5"
  management_group_id  = azurerm_management_group.management_group.id
  policy_definition_id = "/providers/Microsoft.Authorization/policySetDefinitions/7c53f571-2103-44e1-b4c5-7711e86c0743"
  enforce              = false
}
