...
![Controls](https://img.shields.io/badge/Controls-24%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-6-0078D4)
![Tier](https://img.shields.io/badge/Tier-premium-orange)

> **9 frameworks** · **6 modules** · **24+ controls mapped**
> Pattern: `governance-organization` (tier premium)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-2, DP-3, DS-2, DS-4, DS-6, GS-2, GS-5, IM-1, LT-7, NS-8, PA-7, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
| 📋 **CIS Azure** — CIS Benchmarks v2.1 | — | [CIS Azure](https://www.cisecurity.org/benchmark/azure) |
| 🏛️ **ISO 27001:2022** — Annex A | A.5.1, A.8.3, A.8.9 | [ISO 27001](https://www.iso.org/standard/27001) |
...
| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| 🇪🇺 **RGPD** — EU General Data Protection Regulation | ART-25, ART-30, ART-32 | [GDPR Text](https://gdpr-info.eu/) |
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2a, ART-21-2f, ART-21-2i | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R9, R10 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
...
| **policy-initiatives** | **CAF**: GOV-2 · **MCSB**: PV-1, GS-5 · **RGPD**: ART-25 · **NIS2**: ART-21-2a |
| **policy-assignments** | **CAF**: GOV-2, SEC-1 · **MCSB**: PV-2, GS-5 · **RGPD**: ART-25, ART-32 · **NIS2**: ART-21-2a, ART-21-2f |
| **policy-exemptions** | **CAF**: GOV-2 · **MCSB**: PV-2 · **RGPD**: ART-30 · **NIS2**: ART-21-2f |
| **custom-rbac-definitions** | **CAF**: SEC-1, GOV-1 · **MCSB**: PA-7, IM-1 · **RGPD**: ART-25, ART-32 · **NIS2**: ART-21-2i |
