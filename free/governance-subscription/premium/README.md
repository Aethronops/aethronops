# governance-subscription — Enterprise

<!-- Badges -->
![Terraform](https://img.shields.io/badge/Terraform-%3E%3D1.9-844FBA?logo=terraform&logoColor=white)
![AVM](https://img.shields.io/badge/Azure%20Verified%20Modules-12%20modules-0078D4?logo=microsoftazure&logoColor=white)
![Resources](https://img.shields.io/badge/Terraform%20Resources-36-844FBA)
...
| **AVM Modules** | 12 Azure Verified Modules |
| **Terraform Resources** | 36 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (12 modules, 36 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 12 modules AVM, 36 Terraform resources, premium tier</sub>
</p>
...
| defender-plans | All plans (VMs P2 + AppServices + Containers + ARM + DNS ... | 0.0169 EUR/hours | 29 — 29 EUR |
...
**SLA composite** : **99.3717%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.99% × 99.90% × 99.90% × 99.90% × 99.90% × 99.90% = 99.3717%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 271.43 minutes |
| Par an | 3304.71 minutes (55.08 heures) |
