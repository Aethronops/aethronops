...
![Controls](https://img.shields.io/badge/Controls-60%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-12-0078D4)
![Tier](https://img.shields.io/badge/Tier-premium-orange)

> **9 frameworks** · **12 modules** · **60+ controls mapped**
> Pattern: `governance-subscription` (tier premium)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-2, AM-3, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, ES-1, GS-3, IM-1, IM-3, IM-4, IR-1, IR-2, IR-3, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-2, PA-7, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
...
| 🏛️ **ISO 27001:2022** — Annex A | A.5.1, A.5.15, A.8.10, A.8.12, A.8.15, A.8.16, A.8.24, A.8.3, A.8.5, A.8.9 | [ISO 27001](https://www.iso.org/standard/27001) |
...
| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | DATA-1, FINOPS-1, GOV-1, GOV-3, ID-1, ID-2, MGMT-1, MON-1, NAMING-1, OPS-1, OPS-2, RG-1, RG-2, SEC-1, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2a, ART-21-2b, ART-21-2e, ART-21-2f, ART-21-2h, ART-21-2i, ART-23 | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R2, R4, R5, R6, R9, R10 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
