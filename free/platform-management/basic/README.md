...
![Resources](https://img.shields.io/badge/Terraform%20Resources-14-844FBA)
...
| **Terraform Resources** | 14 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (6 modules, 14 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 6 modules AVM, 14 Terraform resources, basic tier</sub>
</p>
...
**SLA composite** : **99.6804%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.90% × 99.90% = 99.6804%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 138.08 minutes |
| Par an | 1681.17 minutes (28.02 heures) |
