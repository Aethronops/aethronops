...
![Resources](https://img.shields.io/badge/Terraform%20Resources-25-844FBA)
...
| **Terraform Resources** | 25 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (8 modules, 25 resources)</summary>
...
| **automation-account** | automation-account | See .tf file header |
...
| automation-account | `Azure/avm-res-automation-automationaccount/azurerm` | `~> 0.2` | [Registry](https://registry.terraform.io/modules/Azure/avm-res-automation-automationaccount/azurerm) |
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 8 modules AVM, 25 Terraform resources, premium tier</sub>
</p>
...
| automation-account | Free for first 500 minutes/month of job runtime. | Free | 0 EUR |
...
> Free tier: 5 GB/month., Free tier: 5 GB/month.
...
| `automation-account` | 99.90% | SLA Azure Automation |
| `backup-vault` | 99.90% | SLA Azure Backup |

## SLA Composite

**SLA composite** : **99.5707%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.99% × 99.90% × 99.90% × 99.90% = 99.5707%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 185.45 minutes |
| Par an | 2257.83 minutes (37.63 heures) |
