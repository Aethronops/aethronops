# Security Controls Mapping — platform-management

![Frameworks](https://img.shields.io/badge/Frameworks-9-success)
![Controls](https://img.shields.io/badge/Controls-59%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-8-0078D4)
![Tier](https://img.shields.io/badge/Tier-premium-orange)

> **9 frameworks** · **8 modules** · **59+ controls mapped**
> Pattern: `platform-management` (tier premium)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-2, BR-1, BR-2, BR-3, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, GS-3, IM-1, IM-3, IM-4, IR-1, IR-3, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-2, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
| 📋 **CIS Azure** — CIS Benchmarks v2.1 | 1.1, 3.1, 3.10, 3.2, 3.7, 5.1.1, 5.1.4, 5.1.5, 8.1, 8.2, 8.4 | [CIS Azure](https://www.cisecurity.org/benchmark/azure) |
| 🏛️ **ISO 27001:2022** — Annex A | A.5.1, A.5.15, A.8.10, A.8.12, A.8.13, A.8.14, A.8.15, A.8.16, A.8.24, A.8.3, A.8.5, A.8.9 | [ISO 27001](https://www.iso.org/standard/27001) |
| 🔍 **SOC 2** — Trust Services Criteria | A1.1, A1.2, CC1.1, CC5.2, CC6.1, CC6.3, CC7.1, CC7.2, CC7.3, CC8.1 | [AICPA TSC](https://www.aicpa.org/soc2) |
| 💳 **PCI-DSS 4.0** — Payment Card Industry | 2.2, 3.1, 3.5, 3.6, 4.2, 7.2, 8.3, 8.6, 10.2, 10.3, 10.7, 11.3, 12.2 | [PCI SSC](https://www.pcisecuritystandards.org/) |

### Microsoft Frameworks

| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | DATA-1, DATA-3, GOV-1, GOV-3, ID-1, ID-2, MGMT-1, NAMING-1, OPS-1, OPS-2, OPS-3, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R2, R4, R5, R6, R7, R9, R10 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
...
| Component | Compliance Controls |
|:----------|:-------------------|
| **automation-account** | **CAF**: MGMT-1, NAMING-1 · **MCSB**: IM-3, LT-3 · **RGPD**: ART-32 · **NIS2**: ART-21-2e, ART-21-2f |
