...
![Resources](https://img.shields.io/badge/Terraform%20Resources-15-844FBA)
![Tier](https://img.shields.io/badge/Tier-basic-blue)
...
| **Terraform Resources** | 15 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (7 modules, 15 resources)</summary>
...
Values in `terraform.tfvars` correspond to your chosen tier (**basic**).
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 7 modules AVM, 15 Terraform resources, basic tier</sub>
</p>
...
**SLA composite** : **99.6305%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.95% × 99.90% × 99.90% = 99.6305%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 159.62 minutes |
| Par an | 1943.31 minutes (32.39 heures) |
