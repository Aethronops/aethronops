...
![AVM](https://img.shields.io/badge/Azure%20Verified%20Modules-10%20modules-0078D4?logo=microsoftazure&logoColor=white)
...
| **AVM Modules** | 10 Azure Verified Modules |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (10 modules, 40 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 10 modules AVM, 40 Terraform resources, standard tier</sub>
</p>
...
| `storage-account` | 99.90% | 99.9% LRS/ZRS/GRS, 99.99% RA-GRS/RA-GZRS (lecture secondaire) |
...
**SLA composite** : **99.6006%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.95% × 99.90% × 99.90% × 99.99% × 99.99% × 99.99% = 99.6006%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 172.53 minutes |
| Par an | 2100.50 minutes (35.01 heures) |
