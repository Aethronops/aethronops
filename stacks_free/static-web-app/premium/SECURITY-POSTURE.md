# Security Controls Mapping — static-web-app

![Frameworks](https://img.shields.io/badge/Frameworks-9-success)
![Controls](https://img.shields.io/badge/Controls-68%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-13-0078D4)
![Tier](https://img.shields.io/badge/Tier-premium-orange)

> **9 frameworks** · **13 modules** · **68+ controls mapped**
> Pattern: `static-web-app` (tier premium)
...
| Network isolation | Virtual Network with dedicated subnets | Network | networking.tf |
| Network filtering | NSG rules — deny by default, allow by exception | Network | networking.tf |
| Private connectivity | Private Endpoints — services accessible only via VNet | Network | networking.tf |
| Centralized logging | Log Analytics Workspace — audit trail, diagnostics, alerts | Monitoring | monitoring.tf |
| Backup & DR | Backup Vault with configurable retention policies | Resilience | backup.tf |
...
> [!TIP]
> All network security controls are **enabled** at maximum level in tier premium.
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-2, BR-1, BR-2, BR-3, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, GS-2, GS-3, GS-4, IM-1, IM-3, IM-4, IR-1, IR-3, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-1, NS-2, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
| 📋 **CIS Azure** — CIS Benchmarks v2.1 | 1.1, 3.1, 3.10, 3.2, 3.7, 5.1.1, 5.1.4, 5.1.5, 6.1, 6.2, 8.1, 8.2, 8.4 | [CIS Azure](https://www.cisecurity.org/benchmark/azure) |
| 🏛️ **ISO 27001:2022** — Annex A | A.5.1, A.5.15, A.8.10, A.8.12, A.8.13, A.8.14, A.8.15, A.8.16, A.8.20, A.8.21, A.8.22, A.8.24, A.8.3, A.8.5, A.8.9 | [ISO 27001](https://www.iso.org/standard/27001) |
| 🔍 **SOC 2** — Trust Services Criteria | A1.1, A1.2, CC1.1, CC5.2, CC6.1, CC6.3, CC6.6, CC6.7, CC7.1, CC7.2, CC7.3, CC8.1 | [AICPA TSC](https://www.aicpa.org/soc2) |
| 💳 **PCI-DSS 4.0** — Payment Card Industry | 1.2, 1.3, 2.2, 3.1, 3.5, 3.6, 4.2, 7.2, 8.3, 8.6, 10.2, 10.3, 10.7, 11.3, 12.2 | [PCI SSC](https://www.pcisecuritystandards.org/) |

### Microsoft Frameworks

| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | APP-1, DATA-1, DATA-2, DATA-3, GOV-1, GOV-3, ID-1, ID-2, LZ-1, NAMING-1, NET-1, NET-2, NET-3, NET-4, OPS-1, OPS-2, OPS-3, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| 🇪🇺 **RGPD** — EU General Data Protection Regulation | ART-25, ART-30, ART-32, ART-33, ART-5 | [GDPR Text](https://gdpr-info.eu/) |
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2a, ART-21-2b, ART-21-2c, ART-21-2e, ART-21-2f, ART-21-2h, ART-21-2i, ART-23 | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R2, R3, R4, R5, R6, R7, R9, R10, R11 | [ANSSI Cloud](https://cyber.gouv.fr/publications/recommandations-relatives-a-lhebergement-dans-le-cloud) |
...
| Art. 11 | Response & recovery | Backup Vault, zone-redundancy, cross-region restore |
| Art. 12 | Backup policies | Immutable backups, WORM storage, geo-redundant vault |
...
|:----------|:-------------------|
| **virtual-network** | **CAF**: NET-1, NET-2, LZ-1 · **MCSB**: NS-1, NS-2 · **NIS2**: ART-21-2a |
| **nat-gateway** | **CAF**: NET-1, NAMING-1 · **MCSB**: NS-1, NS-2 · **NIS2**: ART-21-2a |
| **network-security-group** | **CAF**: NET-3 · **MCSB**: NS-1 · **NIS2**: ART-21-2a |
| **private-endpoint-kv** | **CAF**: NET-4, DATA-2 · **MCSB**: NS-2, DP-3 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2a, ART-21-2h |
| **private-endpoint-storage** | **CAF**: NET-4, DATA-2 · **MCSB**: NS-2, DP-3 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2a, ART-21-2h |
...
| **key-vault** | **CAF**: SEC-3, SEC-4 · **MCSB**: DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8 · **RGPD**: ART-32 · **NIS2**: ART-21-2h · **DORA**: ART-9, ART-12 |

#### 💾 Data

| Component | Compliance Controls |
|:----------|:-------------------|
| **storage-account** | **CAF**: DATA-1 · **MCSB**: DP-1, DP-3, NS-2, AM-2 · **RGPD**: ART-32, ART-5 · **NIS2**: ART-21-2h |
...
| **application-insights** | **CAF**: OPS-1, OPS-2 · **MCSB**: LT-1, LT-3, LT-4, IR-1, IR-3 · **RGPD**: ART-32, ART-33 · **NIS2**: ART-21-2a, ART-23 |
| **backup-vault** | **CAF**: OPS-3, DATA-3 · **MCSB**: BR-1, BR-2, BR-3 · **RGPD**: ART-32 · **NIS2**: ART-21-2c, ART-21-2e · **DORA**: ART-11, ART-12 |

#### ⚙️ Compute

| Component | Compliance Controls |
|:----------|:-------------------|
| **static-web-app** | **CAF**: APP-1, NAMING-1 · **MCSB**: DP-3, NS-2 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2c, ART-21-2e |
...
| GS-2 | Network segmentation via VNet/NSG/subnets | AethronOps platform |
| GS-3 | Data protection strategy (encryption, KV, PE) | AethronOps platform |
| GS-4 | Network security strategy implemented | AethronOps platform |
...
| Network isolation | Private endpoints (premium) | VNet mandatory? _____ | ☐ |
