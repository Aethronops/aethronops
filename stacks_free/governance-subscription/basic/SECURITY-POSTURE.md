...
![Controls](https://img.shields.io/badge/Controls-30%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-5-0078D4)
![Tier](https://img.shields.io/badge/Tier-basic-orange)

> **9 frameworks** · **5 modules** · **30+ controls mapped**
> Pattern: `governance-subscription` (tier basic)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-3, DS-2, DS-4, DS-6, IR-1, IR-2, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
| 📋 **CIS Azure** — CIS Benchmarks v2.1 | 5.1.1, 5.1.4, 5.1.5 | [CIS Azure](https://www.cisecurity.org/benchmark/azure) |
| 🏛️ **ISO 27001:2022** — Annex A | A.5.1, A.8.15, A.8.16, A.8.9 | [ISO 27001](https://www.iso.org/standard/27001) |
| 🔍 **SOC 2** — Trust Services Criteria | CC1.1, CC5.2, CC7.1, CC7.2, CC7.3, CC8.1 | [AICPA TSC](https://www.aicpa.org/soc2) |
| 💳 **PCI-DSS 4.0** — Payment Card Industry | 2.2, 4.2, 10.2, 10.3, 10.7, 11.3, 12.2 | [PCI SSC](https://www.pcisecuritystandards.org/) |

### Microsoft Frameworks

| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | FINOPS-1, GOV-1, GOV-3, MON-1, OPS-1, OPS-2, RG-1, RG-2, SEC-1 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| 🇪🇺 **RGPD** — EU General Data Protection Regulation | ART-30, ART-32, ART-33 | [GDPR Text](https://gdpr-info.eu/) |
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2b, ART-21-2f | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R5, R6, R9 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
