...
resource "azurerm_management_lock" "rg_lock" {
  ...
  depends_on = [module.application_insights, module.automation_account, module.backup_vault, module.key_vault, module.log_analytics, module.managed_identity, module.storage_account]
}
