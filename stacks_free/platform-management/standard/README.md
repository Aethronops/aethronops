# platform-management — Production
...
![Resources](https://img.shields.io/badge/Terraform%20Resources-30-844FBA)
...
| **Terraform Resources** | 30 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (8 modules, 30 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 8 modules AVM, 30 Terraform resources, standard tier</sub>
</p>
...
**SLA composite** : **99.4811%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.90% × 99.90% × 99.90% × 99.90% = 99.4811%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 224.16 minutes |
| Par an | 2729.21 minutes (45.49 heures) |
