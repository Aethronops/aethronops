...
![Controls](https://img.shields.io/badge/Controls-50%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-6-0078D4)
![Tier](https://img.shields.io/badge/Tier-basic-orange)

> **9 frameworks** · **6 modules** · **50+ controls mapped**
> Pattern: `platform-management` (tier basic)
...
| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | DATA-1, GOV-1, GOV-3, ID-1, ID-2, OPS-1, OPS-2, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2a, ART-21-2b, ART-21-2f, ART-21-2h, ART-21-2i, ART-23 | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R2, R4, R5, R6, R9 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
