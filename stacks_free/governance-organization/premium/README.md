# governance-organization — Enterprise

<!-- Badges -->
![Terraform](https://img.shields.io/badge/Terraform-%3E%3D1.9-844FBA?logo=terraform&logoColor=white)
![AVM](https://img.shields.io/badge/Azure%20Verified%20Modules-6%20modules-0078D4?logo=microsoftazure&logoColor=white)
![Resources](https://img.shields.io/badge/Terraform%20Resources-12-844FBA)
...
| | |
|---|---|
| **Pattern** | `governance-organization` |
| **Tier** | premium (Enterprise) |
| **AVM Modules** | 6 Azure Verified Modules |
| **Terraform Resources** | 12 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (6 modules, 12 resources)</summary>

| Resource | Purpose | Security |
|:---------|:--------|:---------|
| **management-group** | management-group | See .tf file header |
| **policy-definitions** | policy-definitions | See .tf file header |
| **policy-initiatives** | policy-initiatives | See .tf file header |
| **policy-assignments** | policy-assignments | See .tf file header |
| **policy-exemptions** | policy-exemptions | See .tf file header |
| **custom-rbac-definitions** | custom-rbac-definitions | See .tf file header |
...
|:----------|:-------|:--------|:-----|
| management-group | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
| policy-definitions | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
| policy-initiatives | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
| policy-assignments | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
| policy-exemptions | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
| custom-rbac-definitions | `` (native) | azurerm ~> 4.0 | [Provider docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest) |
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 6 modules AVM, 12 Terraform resources, premium tier</sub>
</p>
...
|----------|-------------|------------|-------------------|
| management-group | Management Groups are free. | Free | 0 EUR |
| policy-definitions | Azure Policy is free. | Free | 0 EUR |
| policy-initiatives | Azure Policy initiatives are free. | Free | 0 EUR |
| policy-assignments | Azure Policy assignments are free. | Free | 0 EUR |
| policy-exemptions | Azure Policy exemptions are free. | Free | 0 EUR |
| custom-rbac-definitions | RBAC definitions are free. | Free | 0 EUR |
| **Total** | | | **0 — 0 EUR/month** |
...
**Tier** : premium
**Briques** : 6 (5 impactant le SLA)

## Détail par brique

| Brique | SLA (%) | Note |
|--------|---------|------|
| `management-group` | 100% (pas d'impact) | Plan de contrôle Azure — pas d'impact SLA |
| `policy-definitions` | 99.90% | SLA inconnu — valeur conservative 99.9% |
| `policy-initiatives` | 99.90% | SLA inconnu — valeur conservative 99.9% |
| `policy-assignments` | 99.90% | SLA inconnu — valeur conservative 99.9% |
| `policy-exemptions` | 99.90% | SLA inconnu — valeur conservative 99.9% |
| `custom-rbac-definitions` | 99.90% | SLA inconnu — valeur conservative 99.9% |

## SLA Composite

**SLA composite** : **99.5010%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.90% × 99.90% × 99.90% × 99.90% = 99.5010%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 215.57 minutes |
| Par an | 2624.55 minutes (43.74 heures) |
