...
![Resources](https://img.shields.io/badge/Terraform%20Resources-37-844FBA)
...
| **Terraform Resources** | 37 resources deployed |
| **Region** | `westeurope` |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (7 modules, 37 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v2</strong> — 7 modules AVM, 37 Terraform resources, standard tier</sub>
</p>
...
**SLA composite** : **99.7602%**
**Classe de disponibilité** : two nines (99%)

**Formule** : 99.90% × 99.99% × 99.99% × 99.90% × 99.99% × 99.99% = 99.7602%

## Temps d'indisponibilité estimé

| Période | Downtime |
|---------|----------|
| Par mois | 103.60 minutes |
| Par an | 1261.33 minutes (21.02 heures) |
