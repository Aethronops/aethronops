# Security Controls Mapping — storage-baseline

![Frameworks](https://img.shields.io/badge/Frameworks-9-success)
![Controls](https://img.shields.io/badge/Controls-64%2B-blue)
![Bricks](https://img.shields.io/badge/Modules-10-0078D4)
![Tier](https://img.shields.io/badge/Tier-premium-orange)

> **9 frameworks** · **10 modules** · **64+ controls mapped**
> Pattern: `storage-baseline` (tier premium)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, AM-2, BR-1, BR-2, BR-3, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, GS-2, GS-3, GS-4, IM-1, IM-3, IM-4, IR-1, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-1, NS-2, PV-1, PV-2 | [MCSB v1](https://learn.microsoft.com/security/benchmark/azure/overview) |
...
| 💳 **PCI-DSS 4.0** — Payment Card Industry | 1.3, 2.2, 3.1, 3.5, 3.6, 4.2, 7.2, 8.3, 8.6, 10.2, 10.3, 10.7, 11.3, 12.2 | [PCI SSC](https://www.pcisecuritystandards.org/) |

### Microsoft Frameworks

| Framework | Controls Covered | Reference |
|:----------|:----------------|:----------|
| ☁️ **CAF** — Cloud Adoption Framework | DATA-1, DATA-2, DATA-3, GOV-1, GOV-3, ID-1, ID-2, LZ-1, NAMING-1, NET-1, NET-2, NET-4, OPS-1, OPS-2, OPS-3, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| 🛡️ **NIS2** — EU Directive 2022/2555 | ART-21-2a, ART-21-2b, ART-21-2c, ART-21-2e, ART-21-2f, ART-21-2h, ART-21-2i | [NIS2 Directive](https://eur-lex.europa.eu/eli/dir/2022/2555) |
| 🇫🇷 **ANSSI** — Guide cloud SecNumCloud | R1, R2, R3, R4, R5, R6, R7, R9, R10 | [ANSSI Cloud](https://www.ssi.gouv.fr/guide/recommandations-cloud/) |
