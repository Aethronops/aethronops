...
resource "azurerm_management_lock" "rg_lock" {
  ...
  depends_on = [module.backup_vault, module.key_vault, module.log_analytics, module.managed_identity, module.nat_gateway, module.storage_account, module.virtual_network]
}
