...
![Resources](https://img.shields.io/badge/Terraform%20Resources-26-844FBA)
...
> **Cost & Performance** — ~€15-30/month, deploys in 5-8 minutes, 26 Terraform resources.
...
```hcl
module "container_apps_mongodb" {
  source  = "aethronops/container-apps-mongodb/azurerm"
  version = "~> 3.0"
...
| | |
|---|---|
| **Pattern** | `container-apps-mongodb` |
| **Tier** | dev (Dev) |
| **AVM Modules** | 8 Azure Verified Modules |
| **Terraform Resources** | 26 resources deployed |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (8 modules, 26 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 8 modules AVM, 26 Terraform resources, dev tier</sub>
</p>
