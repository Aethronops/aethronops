# Security Controls Mapping — container-apps-mongodb

![Frameworks](https://img.shields.io/badge/Frameworks-6-success)
![Controls](https://img.shields.io/badge/Controls-60-blue)
![Bricks](https://img.shields.io/badge/Modules-8-0078D4)
![Tier](https://img.shields.io/badge/Tier-dev-orange)

> **6 frameworks** · **8 modules** · **60 controls mapped**
> Pattern: `container-apps-mongodb` (tier dev)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, GS-3, IM-1, IM-3, IM-4, IR-1, IR-3, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-2, PV-1, PV-2 | [MCSB](https://learn.microsoft.com/security/benchmark/azure/overview) |
