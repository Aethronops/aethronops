# container-apps-mongodb — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/container-apps-mongodb/](https://aethronops.com/stacks/container-apps-mongodb/).
...
- **13 Azure Verified Modules** wiring **49 Terraform resources** end-to-end
- **19 `.tf` files · 1,578 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
- **Azure DocumentDB (MongoDB vCore)** — TLS 1.3, Zone HA optional, 7–35d backup, audit logging, post-deploy bootstrap (database, extensions, Entra admin group)
...
- **6 recommended MongoDB alerts** routed to email action group (CPU, memory, storage, connections, deadlocks, IOPS where applicable)
...
| `mongo_cluster` | `Azure/avm-res-documentdb-mongocluster/azurerm` | `~> 0.1` |
| `private_endpoint_kv` | `Azure/avm-res-network-privateendpoint/azurerm` | `0.2.0` |
| `private_endpoint_mongo` | `Azure/avm-res-network-privateendpoint/azurerm` | `0.2.0` |
...
Ideal for containerized MongoDB-backed apps.

---

**Buy production:** [aethronops.com/stacks/container-apps-mongodb/](https://aethronops.com/stacks/container-apps-mongodb/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
