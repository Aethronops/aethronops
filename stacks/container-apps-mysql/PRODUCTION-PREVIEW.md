# container-apps-mysql — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/container-apps-mysql/](https://aethronops.com/stacks/container-apps-mysql/).
...
- **9 Azure Verified Modules** wiring **48 Terraform resources** end-to-end
- **15 `.tf` files · 1,525 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
Ideal for containerized PHP/Node apps.

---

**Buy production:** [aethronops.com/stacks/container-apps-mysql/](https://aethronops.com/stacks/container-apps-mysql/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
