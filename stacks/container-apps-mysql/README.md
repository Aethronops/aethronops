...
```hcl
module "container_apps_mysql" {
  source  = "aethronops/container-apps-mysql/azurerm"
  version = "~> 3.0"
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (7 modules, 29 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 7 modules AVM, 29 Terraform resources, dev tier</sub>
</p>
