# Security Controls Mapping — container-apps-cosmosdb
...
> Pattern: `container-apps-cosmosdb` (tier dev)
...
| Component | Alignment Controls |
|:----------|:-------------------|
| **cosmosdb-account** | **CAF**: DATA-1, DATA-2 · **MCSB**: DP-1, DP-3, NS-2 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2c, ART-21-2e |
