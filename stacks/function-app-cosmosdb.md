...
Azure Functions with Cosmos DB, Key Vault, Storage, and monitoring. For serverless APIs with NoSQL backend.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/function-app-cosmosdb)**
