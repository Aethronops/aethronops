...
Azure OpenAI + AI Search + App Service chatbot with RAG architecture and monitoring.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/chatbot-enterprise)**
