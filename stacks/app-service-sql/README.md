...
```hcl
module "app_service_sql" {
  source  = "aethronops/app-service-sql/azurerm"
  version = "~> 3.0"
...
| **Azure SQL Database** | Managed SQL Server — elastic pools, HA, geo-replication. | TDE encryption, AAD auth, auditing to Log Analytics (MCSB DP-1/DP-3) |
...
| sql-database | `Azure/avm-res-sql-server/azurerm` | `0.1.6` | [Registry](https://registry.terraform.io/modules/Azure/avm-res-sql-server/azurerm) |
