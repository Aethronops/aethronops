# app-service-sql — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/app-service-sql/](https://aethronops.com/stacks/app-service-sql/).
...
- **11 Azure Verified Modules** wiring **58 Terraform resources** end-to-end
- **17 `.tf` files · 1,895 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
Ideal for .NET, ASP.NET Core, Entity Framework.

---

**Buy production:** [aethronops.com/stacks/app-service-sql/](https://aethronops.com/stacks/app-service-sql/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
