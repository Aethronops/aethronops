...
Azure AI Speech with Key Vault and monitoring. Speech-to-text, text-to-speech, and real-time translation.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/speech-baseline)**
