...
Monitoring pack for an existing Azure Cache for Redis. Adds Log Analytics, diagnostic settings, and alerts.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/db-admin-redis)**
