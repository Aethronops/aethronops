...
Administration pack for an existing Azure Cache for Redis. Adds monitoring, alerting, and diagnostic settings.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/db-admin-redis)**
