...
Azure Cache for Redis with App Service, Key Vault, and monitoring. For session caching and pub/sub messaging.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/redis-cache-app)**
