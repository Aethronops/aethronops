# app-service-mongodb — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/app-service-mongodb/](https://aethronops.com/stacks/app-service-mongodb/).
...
- **12 Azure Verified Modules** wiring **59 Terraform resources** end-to-end
- **19 `.tf` files · 1,814 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
Ideal for MEAN, MERN, Spring+Mongo.

---

**Buy production:** [aethronops.com/stacks/app-service-mongodb/](https://aethronops.com/stacks/app-service-mongodb/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
