# Security Controls Mapping — app-service-mongodb
...
> Pattern: `app-service-mongodb` (tier dev)
...
| Component | Alignment Controls |
|:----------|:-------------------|
| **mongo-cluster** | **CAF**: DATA-1, DATA-2 · **MCSB**: DP-1, DP-3, DP-4, NS-2 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2c, ART-21-2e |
