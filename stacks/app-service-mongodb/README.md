...
```hcl
module "app_service_mongodb" {
  source  = "aethronops/app-service-mongodb/azurerm"
  version = "~> 3.0"
...
| **Mongo Cluster** | See `mongo-cluster` section in .tf files | Configured per tier |
...
| mongo-cluster | `Azure/avm-res-documentdb-mongocluster/azurerm` | `~> 0.1` | [Registry](https://registry.terraform.io/modules/Azure/avm-res-documentdb-mongocluster/azurerm) |
