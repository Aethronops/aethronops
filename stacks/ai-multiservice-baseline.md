...
Azure AI Services (multi-service Cognitive Account) with Key Vault and monitoring. Access Vision, Language, Speech, and Decision APIs from a single endpoint.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/ai-multiservice-baseline)**
