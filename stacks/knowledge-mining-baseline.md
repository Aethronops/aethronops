...
Azure AI Search with Cognitive Skills, Storage (data source), Key Vault, and monitoring. Extract insights from unstructured documents at scale.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/knowledge-mining-baseline)**
