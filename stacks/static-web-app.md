...
Azure Static Web App for SPA (React, Vue, Angular) and JAMstack sites. Global CDN, custom domains, free SSL, staging environments per pull request.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/static-web-app)**
