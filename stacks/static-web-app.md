...
Azure Static Web App for SPA and JAMstack. Global CDN, custom domains, free SSL, staging environments.
...
- **Premium** (40 resources) — Enterprise — adds Private Endpoints, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/static-web-app)**
