...
MongoDB on Azure VM with managed disks, Key Vault, monitoring, and backup. For workloads requiring full MongoDB control not available in Cosmos DB.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/vm-mongodb-iaas)**
