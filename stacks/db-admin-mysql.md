...
Monitoring pack for an existing MySQL Flexible Server. Adds Log Analytics, diagnostic settings, alerts, and backup configuration.
...
- **Premium** (99 resources) — Enterprise — adds Private Endpoints, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/db-admin-mysql)**
