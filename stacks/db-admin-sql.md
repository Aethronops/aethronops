...
Administration pack for an existing Azure SQL Database. Adds monitoring, alerting, vulnerability assessment, and auditing.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/db-admin-sql)**
