...
Monitoring pack for an existing Azure SQL Database. Adds Log Analytics, diagnostic settings, alerts, and auditing.
...
- **Premium** (94 resources) — Enterprise — adds Private Endpoints, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/db-admin-sql)**
