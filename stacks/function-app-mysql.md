...
Azure Functions with MySQL Flexible Server, Key Vault, Storage, and monitoring.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/function-app-mysql)**
