...
Azure Container Apps with MySQL Flexible Server, Key Vault, Managed Identity, and monitoring.
...
- **Premium** (63 resources) — Enterprise — adds Private Endpoints, Front Door, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/container-app-mysql)**
