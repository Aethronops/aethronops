...
> **Cost & Performance** — ~€15-30/month, deploys in 5-8 minutes, 30 Terraform resources.
...
```hcl
module "container_apps_postgresql" {
  source  = "aethronops/container-apps-postgresql/azurerm"
  version = "~> 3.0"
...
| | |
|---|---|
| **Pattern** | `container-apps-postgresql` |
| **Tier** | dev (Dev) |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (7 modules, 30 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 7 modules AVM, 30 Terraform resources, dev tier</sub>
</p>
