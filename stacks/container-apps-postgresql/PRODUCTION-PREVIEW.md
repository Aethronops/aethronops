# container-apps-postgresql — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/container-apps-postgresql/](https://aethronops.com/stacks/container-apps-postgresql/).
...
- **9 Azure Verified Modules** wiring **49 Terraform resources** end-to-end
- **15 `.tf` files · 1,600 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
- **PostgreSQL Flexible Server** — TLS 1.3, Zone HA optional, 7–35d backup, audit logging, post-deploy bootstrap (database, extensions, Entra admin group)
...
- **6 recommended PostgreSQL alerts** routed to email action group (CPU, memory, storage, connections, deadlocks, IOPS where applicable)
...
| `postgresql_flexible` | `Azure/avm-res-dbforpostgresql-flexibleserver/azurerm` | `0.2.0` |
...
Ideal for microservices Node.js, Python, Go.

---

**Buy production:** [aethronops.com/stacks/container-apps-postgresql/](https://aethronops.com/stacks/container-apps-postgresql/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
