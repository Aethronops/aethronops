...
Azure OpenAI + AI Search + Storage. The standard architecture for grounding LLM responses with your own documents.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/rag-baseline)**
