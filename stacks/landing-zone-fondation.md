...
Governance, monitoring, and identity baseline. The prerequisite for workload deployments. CAF-aligned.
...
- **Premium** (46 resources) — Enterprise — adds Private Endpoints, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/landing-zone-fondation)**
