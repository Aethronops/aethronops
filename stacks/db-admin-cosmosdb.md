...
Administration pack for an existing Cosmos DB account. Adds monitoring, alerting, diagnostic settings, and backup configuration without redeploying the database.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/db-admin-cosmosdb)**
