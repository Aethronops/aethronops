...
![Resources](https://img.shields.io/badge/Terraform%20Resources-32-844FBA)
...
> **Cost & Performance** — ~€15-30/month, deploys in 5-8 minutes, 32 Terraform resources.
...
```hcl
module "app_service_mysql" {
  source  = "aethronops/app-service-mysql/azurerm"
  version = "~> 3.0"
...
| | |
|---|---|
| **Pattern** | `app-service-mysql` |
| **Tier** | dev (Dev) |
| **AVM Modules** | 8 Azure Verified Modules |
| **Terraform Resources** | 32 resources deployed |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (8 modules, 32 resources)</summary>
...
| **MySQL Flexible Server** | Managed MySQL database — HA, automated backups, scaling. | TLS 1.3 enforced, VNet integration in premium, automated backups (MCSB DP-1/DP-3) |
...
- **MySQL Flexible** — stopped off-hours, started on-hours
...
| mysql-flexible | `Azure/avm-res-dbformysql-flexibleserver/azurerm` | `0.1.6` | [Registry](https://registry.terraform.io/modules/Azure/avm-res-dbformysql-flexibleserver/azurerm) |
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 8 modules AVM, 32 Terraform resources, dev tier</sub>
</p>
