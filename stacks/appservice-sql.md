...
Azure App Service with Azure SQL Database, Key Vault, Storage, and monitoring. For .NET, Java, and Power BI workloads using SQL Server.
...
**[View all stacks](https://aethronops.com/stacks) · [Generate this stack](https://aethronops.com/stacks/appservice-sql)**
