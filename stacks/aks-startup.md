...
Lightweight AKS cluster with a single node pool, ACR, Key Vault, and monitoring.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/aks-startup)**
