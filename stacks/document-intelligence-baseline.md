...
Azure AI Document Intelligence (Form Recognizer) with Key Vault and monitoring. Extract text, tables, and structure from documents.
...
- **Premium** (55 resources) — Enterprise — adds Private Endpoints, Backup Vault.
...
**[View all stacks](https://aethronops.com/stacks) · [Get this stack](https://aethronops.com/stacks/document-intelligence-baseline)**
