...
> **Cost & Performance** — ~€15-30/month, deploys in 5-8 minutes, 25 Terraform resources.
...
```hcl
module "container_apps_sql" {
  source  = "aethronops/container-apps-sql/azurerm"
  version = "~> 3.0"
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (7 modules, 25 resources)</summary>
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 7 modules AVM, 25 Terraform resources, dev tier</sub>
</p>
