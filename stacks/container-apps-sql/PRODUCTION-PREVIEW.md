# container-apps-sql — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/container-apps-sql/](https://aethronops.com/stacks/container-apps-sql/).
...
- **10 Azure Verified Modules** wiring **43 Terraform resources** end-to-end
- **16 `.tf` files · 1,436 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
- **Azure SQL Database** — TLS 1.3, Zone HA optional, 7–35d backup, audit logging, post-deploy bootstrap (database, extensions, Entra admin group)
...
- **6 recommended SQL Server alerts** routed to email action group (CPU, memory, storage, connections, deadlocks, IOPS where applicable)
...
| `private_endpoint_sql` | `Azure/avm-res-network-privateendpoint/azurerm` | `0.2.0` |
| `resource_group` | `Azure/avm-res-resources-resourcegroup/azurerm` | `~> 0.2` |
| `sql_database` | `Azure/avm-res-sql-server/azurerm` | `0.1.6` |
...
Ideal for containerized .NET, Java, Node.js.

---

**Buy production:** [aethronops.com/stacks/container-apps-sql/](https://aethronops.com/stacks/container-apps-sql/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
