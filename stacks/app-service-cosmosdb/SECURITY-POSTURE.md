# Security Controls Mapping — app-service-cosmosdb

![Frameworks](https://img.shields.io/badge/Frameworks-4-success)
![Controls](https://img.shields.io/badge/Controls-53-blue)
![Bricks](https://img.shields.io/badge/Modules-8-0078D4)
![Tier](https://img.shields.io/badge/Tier-dev-orange)

> **4 frameworks** · **8 modules** · **53 controls mapped**
> Pattern: `app-service-cosmosdb` (tier dev)
...
|:----------|:----------------|:----------|
| 🔒 **MCSB** — Microsoft Cloud Security Benchmark | AM-1, DP-1, DP-2, DP-3, DP-4, DP-6, DP-7, DP-8, DS-2, DS-4, DS-6, GS-3, IM-1, IM-3, IM-4, IR-1, IR-3, IR-4, LT-1, LT-3, LT-4, LT-5, LT-6, LT-7, NS-1, NS-2, PV-1, PV-2 | [MCSB](https://learn.microsoft.com/security/benchmark/azure/overview) |
| ☁️ **CAF** — Cloud Adoption Framework | APP-1, DATA-1, DATA-2, GOV-1, GOV-3, ID-1, ID-2, OPS-1, OPS-2, RG-1, RG-2, SEC-3, SEC-4 | [Microsoft CAF](https://learn.microsoft.com/azure/cloud-adoption-framework/) |
...
| Component | Alignment Controls |
|:----------|:-------------------|
| **cosmosdb-baseline** | **CAF**: DATA-1, DATA-2 · **MCSB**: DP-1, DP-3, NS-2 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2c, ART-21-2e |
...
| Component | Alignment Controls |
|:----------|:-------------------|
| **app-service-plan** | **CAF**: APP-1 · **NIS2**: ART-21-2b |
| **app-service** | **CAF**: APP-1, SEC-3 · **MCSB**: NS-1, NS-2, IM-1, DP-3 · **RGPD**: ART-32, ART-25 · **NIS2**: ART-21-2b, ART-21-2h |
