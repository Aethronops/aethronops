...
![Resources](https://img.shields.io/badge/Terraform%20Resources-29-844FBA)
...
> **Cost & Performance** — ~€15-30/month, deploys in 5-8 minutes, 29 Terraform resources.
...
```hcl
module "app_service_cosmosdb" {
  source  = "aethronops/app-service-cosmosdb/azurerm"
  version = "~> 3.0"
...
| | |
|---|---|
| **Pattern** | `app-service-cosmosdb` |
| **Tier** | dev (Dev) |
| **AVM Modules** | 8 Azure Verified Modules |
| **Terraform Resources** | 29 resources deployed |
...
<details open>
<summary><strong>What each resource does and how it is secured</strong> (8 modules, 29 resources)</summary>
...
| **Cosmos DB (cosmosdb-baseline)** | Globally distributed NoSQL database — multi-model, multi-region, low-latency. | Managed Identity, encryption at rest, network isolation in premium (MCSB DP-1/NS-3) |
...
| cosmosdb-baseline | `Azure/avm-res-documentdb-databaseaccount/azurerm` | `~> 0.10` | [Registry](https://registry.terraform.io/modules/Azure/avm-res-documentdb-databaseaccount/azurerm) |
...
<p align="center">
<sub>Generated by <strong>AethronOps v3</strong> — 8 modules AVM, 29 Terraform resources, dev tier</sub>
</p>
