# Security Controls Mapping — app-service-postgresql
...
> Pattern: `app-service-postgresql` (tier dev)
...
| Component | Alignment Controls |
|:----------|:-------------------|
| **postgresql-flexible** | **CAF**: DATA-1, DATA-2 · **MCSB**: DP-4, NS-2, DP-3 · **RGPD**: ART-32 · **NIS2**: ART-21-2c, ART-21-2e |
