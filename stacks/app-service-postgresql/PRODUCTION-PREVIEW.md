# app-service-postgresql — Production Preview

> **This is the open-source DEV variant.** Production is sold separately at [aethronops.com/stacks/app-service-postgresql/](https://aethronops.com/stacks/app-service-postgresql/).
...
- **11 Azure Verified Modules** wiring **60 Terraform resources** end-to-end
- **17 `.tf` files · 1,994 effective HCL lines** (no copy-paste of generic templates — each resource is intentional)
...
Ideal for Django, Rails, Laravel, Next.js.

---

**Buy production:** [aethronops.com/stacks/app-service-postgresql/](https://aethronops.com/stacks/app-service-postgresql/) · 199 € HT (Single) or 499 € HT (All-Access, all 11 stacks)
